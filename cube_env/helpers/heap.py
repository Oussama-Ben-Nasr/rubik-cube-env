...
class HeapStrategy(ABC):
    @abstractmethod
    def heap_sift_down_order(self, first: int, second) -> bool:
        pass
    
    @abstractmethod
    def heap_sift_up_order(self, first: int, second) -> bool:
        pass
...
class Heap(ABC):
    ...
    def valid_index(self, index) -> bool:
    ...
    def sift_up(self, index, order: HeapStrategy) -> None:
        """
    ...
    def sift_down(self, index, order: HeapStrategy) -> None:
        """
